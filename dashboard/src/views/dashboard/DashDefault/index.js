      ...
      <tr className='unread'>
        ...
        <td>
          <h6 className='text-muted'>
            {getIconType(getDaysPast(created_at))}
    ...
    <React.Fragment>
      <Row>
        <Col md={6} xl={4}>
          <Card>
            <Card.Body>
              <h6 className='mb-4'>Active Projects</h6>
        ...
        <Col md={6} xl={4}>
          <Card>
            <Card.Body>
              <h6 className='mb-4'>Total Projects</h6>
              <div className='row d-flex align-items-center'>
                <div className='col-9'>
                  <h3 className='f-w-300 d-flex align-items-center m-b-0'>
        ...
        <Col xl={4}>
          <Card>
            <Card.Body>
              <h6 className='mb-4'>Total Tickets</h6>
              <div className='row d-flex align-items-center'>
                <div className='col-9'>
                  <h3 className='f-w-300 d-flex align-items-center m-b-0'>
                    <i className='feather icon-arrow-up text-c-green f-30 m-r-5' />{" "}
          ...
          <Card className='card-event'>
            <Card.Body>
              <div className='row align-items-center justify-content-center'>
                <div className='col'>
                  <h5 className='m-0'>Unassigned Tickets</h5>
                </div>
              ...
              <h2 className='mt-2 f-w-300'>
                5<sub className='text-muted f-14'>Pending</sub>
              </h2>
          ...
          <Card>
            <Card.Body className='border-bottom'>
              <div className='row d-flex align-items-center'>
                ...
                <div className='col'>
                  <h3 className='f-w-300'>{users.length}</h3>
            ...
            <Card.Body>
              <div className='row d-flex align-items-center'>
                ...
                <div className='col'>
                  ...
                  <span className='d-block text-uppercase'>developers</span>
                </div>
              </div>
            </Card.Body>
          </Card>
